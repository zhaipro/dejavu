...
def generate_test_files(src, dest, nseconds, padding=10):
    '''
    ...
    # find music
    for audiosource in utils.find_files(src):
...
class DejavuTest(object):
    ...
    def begin(self):
        for f in self.test_files:
            ...
            song = utils.path_to_name(f).split('_')[0]
            ...
            if result.strip() == 'None':
                ...
                if song_result != song:
                    ...
                    self.result_query_duration[line][
                        col] = round(result[Dejavu.MATCH_TIME], 3)
                    self.result_match_confidence[line][
                        col] = result[Dejavu.CONFIDENCE]
